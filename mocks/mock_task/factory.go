...
//
//	mockgen -source=./task/factory.go
//
...
import (
	...
	task "github.com/loilo-inc/canarycage/v6/task"
...
func (mr *MockFactoryMockRecorder) NewAlbTask(input, lb any) *gomock.Call {
...
func (mr *MockFactoryMockRecorder) NewSimpleTask(input any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
